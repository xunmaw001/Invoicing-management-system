        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">盘点详情管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">盘点详情列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">盘点详情列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="goodsQianNumberStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="goodsQianNumberChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="goodsQianNumberEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="goodsQianNumberChickValue(this)"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        盘点后数量
                                        <div class="layui-input-inline">
                                            <input type="text" id="pandianOrderListNumberStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="pandianOrderListNumberChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="pandianOrderListNumberEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="pandianOrderListNumberChickValue(this)"
                                                   placeholder="结束" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if( pandianOrderNameSearchInput != null){
                ...
                //盘点前数量
            var goodsQianNumberStartSearchInput = $('#goodsQianNumberStartSearch');
            if(goodsQianNumberStartSearchInput != null){
                var goodsQianNumberStartSearchValue = goodsQianNumberStartSearchInput.val();
                if( goodsQianNumberStartSearchValue  != 0){
                    searchForm.goodsQianNumberStart = goodsQianNumberStartSearchValue;
                }
            }
            var goodsQianNumberEndSearchInput = $('#goodsQianNumberEndSearch');
            if(goodsQianNumberEndSearchInput != null){
                var goodsQianNumberEndSearchValue = goodsQianNumberEndSearchInput.val();
                if( goodsQianNumberEndSearchValue  != 0){
                    searchForm.goodsQianNumberEnd = goodsQianNumberEndSearchValue;
                }
            }
     
                //盘点后数量
            var pandianOrderListNumberStartSearchInput = $('#pandianOrderListNumberStartSearch');
            if(pandianOrderListNumberStartSearchInput != null){
                var pandianOrderListNumberStartSearchValue = pandianOrderListNumberStartSearchInput.val();
                if( pandianOrderListNumberStartSearchValue  != 0){
                    searchForm.pandianOrderListNumberStart = pandianOrderListNumberStartSearchValue;
                }
            }
            var pandianOrderListNumberEndSearchInput = $('#pandianOrderListNumberEndSearch');
            if(pandianOrderListNumberEndSearchInput != null){
                var pandianOrderListNumberEndSearchValue = pandianOrderListNumberEndSearchInput.val();
                if( pandianOrderListNumberEndSearchValue  != 0){
                    searchForm.pandianOrderListNumberEnd = pandianOrderListNumberEndSearchValue;
                }
            }
                    getDataList();
        }
        ...
        function getDataList() {
            http("pandianOrderList/page", "GET", {
                ...
                order: sortOrder,
                //本表的
                goodsQianNumberStart: searchForm.goodsQianNumberStart,
                goodsQianNumberEnd: searchForm.goodsQianNumberEnd,
                pandianOrderListNumberStart: searchForm.pandianOrderListNumberStart,
                pandianOrderListNumberEnd: searchForm.pandianOrderListNumberEnd,
            //级联表的
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addpandianOrderList", "addpandianOrderList");
            window.location.href = "add-or-update.jsp"
        }
