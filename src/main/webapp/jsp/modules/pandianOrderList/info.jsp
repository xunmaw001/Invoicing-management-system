            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">盘点详情登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                    ...
                                    <div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label>操作人</label>
                                            <input id="yuangongId" name="yuangongId" class="form-control"
                                                   v-model="ruleForm.yuangongId" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="pandianOrderName" name="pandianOrderName" class="form-control"
                                                   v-model="ruleForm.pandianOrderName" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="pandianOrderId" name="pandianOrderId" v-model="ruleForm.pandianOrderId" readonly type="hidden">
                                <input id="goodsId" name="goodsId" v-model="ruleForm.goodsId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="goodsQianNumber" name="goodsQianNumber" class="form-control"
                                               v-model="ruleForm.goodsQianNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="pandianOrderListNumber" name="pandianOrderListNumber" class="form-control"
                                               v-model="ruleForm.pandianOrderListNumber" readonly>
                                    </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "pandianOrderList/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.pandianOrderContent != null && ruleForm.pandianOrderContent != 'null' && ruleForm.pandianOrderContent != '') {
            var pandianOrderContentUeditor = UE.getEditor('pandianOrderContentEditor');
                pandianOrderContentUeditor.ready(function () {
                    ...
                    pandianOrderContentUeditor.setDisabled('fullscreen');
            });
        }
    }
