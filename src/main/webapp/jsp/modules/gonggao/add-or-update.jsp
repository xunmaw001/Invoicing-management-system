                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>公告名称</label>
                                        <input id="gonggaoName" name="gonggaoName" class="form-control"
                                               placeholder="公告名称">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>公告类型</label>
                                        <select id="gonggaoTypesSelect" name="gonggaoTypes" class="form-control">
                                        </select>
                                    </div>
                                    <div class="form-group  col-md-6">
                                        <label>公告详情</label>
    ...
    function getContent() {
        ...
        if($("#gonggaoContentupload").length>0) {
            ...
            if (gonggaoContentEditor.hasContents()) {
                $('#gonggaoContent-input').attr('value', gonggaoContentEditor.getPlainTxt());
            }
        }
    }
    //数字检查
