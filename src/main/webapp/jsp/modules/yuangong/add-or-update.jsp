                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="yuangongPhone" name="yuangongPhone" class="form-control"
                                               onchange="yuangongPhoneChickValue(this)"  placeholder="员工手机号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>员工身份证号</label>
                                        <input id="yuangongIdNumber" name="yuangongIdNumber" class="form-control"
                                               onchange="yuangongIdNumberChickValue(this)"  placeholder="员工身份证号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>员工照片</label>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("yuangong/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addyuangong');
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                username: "账户不能为空",
                password: "密码不能为空",
                yuangongName: "员工姓名不能为空",
                yuangongPhone: "员工手机号不能为空",
                yuangongIdNumber: "员工身份证号不能为空",
    ...
    // 获取当前详情
    function getDetails() {
        var addyuangong = window.sessionStorage.getItem("addyuangong");
        if (addyuangong != null && addyuangong != "" && addyuangong != "null") {
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("yuangong/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
