                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">销售列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="goodsOutDanhaoNumberSearch" style="width: 140px;" class="form-control form-control-sm"
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        售卖数量
                                        <div class="layui-input-inline">
                                            <input type="text" id="goodsOutNumberStartSearch" style="width: 100px;" class="form-control form-control-sm" onchange="goodsOutNumberChickValue(this)"
                                                   placeholder="开始" aria-controls="tableId">
                                        </div>
                                    </div>
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        <div class="layui-input-inline">
                                            <input type="text" id="goodsOutNumberEndSearch" style="width: 100px;" class="form-control form-control-sm" onchange="goodsOutNumberChickValue(this)"
...
<%----%>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //单号
            var goodsOutDanhaoNumberSearchInput = $('#goodsOutDanhaoNumberSearch');
            if( goodsOutDanhaoNumberSearchInput != null){
                if (goodsOutDanhaoNumberSearchInput.val() != null && goodsOutDanhaoNumberSearchInput.val() != '') {
                    searchForm.goodsOutDanhaoNumber = $('#goodsOutDanhaoNumberSearch').val();
                }
            }
     
                //售卖数量
            var goodsOutNumberStartSearchInput = $('#goodsOutNumberStartSearch');
            if(goodsOutNumberStartSearchInput != null){
                var goodsOutNumberStartSearchValue = goodsOutNumberStartSearchInput.val();
                if( goodsOutNumberStartSearchValue  != 0){
                    searchForm.goodsOutNumberStart = goodsOutNumberStartSearchValue;
                }
            }
            var goodsOutNumberEndSearchInput = $('#goodsOutNumberEndSearch');
            if(goodsOutNumberEndSearchInput != null){
                var goodsOutNumberEndSearchValue = goodsOutNumberEndSearchInput.val();
                if( goodsOutNumberEndSearchValue  != 0){
                    searchForm.goodsOutNumberEnd = goodsOutNumberEndSearchValue;
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("goodsOut/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                //本表的
                goodsOutDanhaoNumber: searchForm.goodsOutDanhaoNumber,
                goodsOutNumberStart: searchForm.goodsOutNumberStart,
                goodsOutNumberEnd: searchForm.goodsOutNumberEnd,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //单号
            var goodsOutDanhaoNumberCell = document.createElement('td');
            goodsOutDanhaoNumberCell.innerHTML = item.goodsOutDanhaoNumber;
            row.appendChild(goodsOutDanhaoNumberCell);


            //售卖数量
            var goodsOutNumberCell = document.createElement('td');
            goodsOutNumberCell.innerHTML = item.goodsOutNumber;
            row.appendChild(goodsOutNumberCell);
            ...
            row.appendChild(insertTimeCell);
                ...
                //备注
            var goodsOutContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.goodsOutContent && item.goodsOutContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.goodsOutContent.indexOf('<img');
                var endIndex = item.goodsOutContent.indexOf('>');
                    goodsOutContentCell.innerHTML = item.goodsOutContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.goodsOutContent != null && item.goodsOutContent != "" && item.goodsOutContent.length >= 11) {
                        goodsOutContentCell.innerHTML = item.goodsOutContent.substring(0, 10) + "...";
                } else {
                        goodsOutContentCell.innerHTML = item.goodsOutContent;
                }
            }
            row.appendChild(goodsOutContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("goodsOut/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addgoodsOut", "addgoodsOut");
            window.location.href = "add-or-update.jsp"
        }
