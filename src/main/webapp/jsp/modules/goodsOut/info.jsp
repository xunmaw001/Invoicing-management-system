            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">销售登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="huiyuanId" name="huiyuanId" v-model="ruleForm.huiyuanId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="goodsOutDanhaoNumber" name="goodsOutDanhaoNumber" class="form-control"
                                               v-model="ruleForm.goodsOutDanhaoNumber" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="goodsOutNumber" name="goodsOutNumber" class="form-control"
                                               v-model="ruleForm.goodsOutNumber" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.goodsOutContent != null && ruleForm.goodsOutContent != 'null' && ruleForm.goodsOutContent != '') {
            var goodsOutContentUeditor = UE.getEditor('goodsOutContentEditor');
                goodsOutContentUeditor.ready(function () {
                    var mes = '' + ruleForm.goodsOutContent;
                    goodsOutContentUeditor.setContent(mes);
                    goodsOutContentUeditor.setDisabled('fullscreen');
            });
        }
    }
