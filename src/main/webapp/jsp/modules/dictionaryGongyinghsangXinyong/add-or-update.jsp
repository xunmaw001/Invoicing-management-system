    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑供应商信用等级</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">供应商信用等级管理</li>
                        <li class="breadcrumb-item active">编辑供应商信用等级</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">供应商信用等级表信息</h3>
...
<script>
    ...
    var tableName = "dictionaryGongyinghsangXinyong";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "gongyinghsang_xinyong_types";
            data["dicName"] = "供应商信用等级名称";
