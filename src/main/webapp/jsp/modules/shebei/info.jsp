            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">设备登记</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>设备名称</label>
                                        <input id="shebeiName" name="shebeiName" class="form-control"
                                               v-model="ruleForm.shebeiName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>设备类型</label>
                                    <input id="shebeiValue" name="shebeiValue" class="form-control"
                                           v-model="ruleForm.shebeiValue" readonly>
                                </div>


                                    <div class="form-group col-md-6">
                                        <label>设备数量</label>
                                        <input id="shebeiNumber" name="shebeiNumber" class="form-control"
                                               v-model="ruleForm.shebeiNumber" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.shebeiContent != null && ruleForm.shebeiContent != 'null' && ruleForm.shebeiContent != '') {
            var shebeiContentUeditor = UE.getEditor('shebeiContentEditor');
                shebeiContentUeditor.ready(function () {
                    var mes = '' + ruleForm.shebeiContent;
                    shebeiContentUeditor.setContent(mes);
                    shebeiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
