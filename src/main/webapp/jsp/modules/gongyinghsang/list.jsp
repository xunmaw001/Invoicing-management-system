                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">供应商列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">供应商列表</h3>
    ...
    <!-- 本表的查询条件 -->
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("gongyinghsang/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addgongyinghsang", "addgongyinghsang");
            window.location.href = "add-or-update.jsp"
        }
