                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="huiyuanPhone" name="huiyuanPhone" class="form-control"
                                               onchange="huiyuanPhoneChickValue(this)"  placeholder="会员手机号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>会员身份证号</label>
                                        <input id="huiyuanIdNumber" name="huiyuanIdNumber" class="form-control"
                                               onchange="huiyuanIdNumberChickValue(this)"  placeholder="会员身份证号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>会员照片</label>
...
<script>
    ...
    //数字检查
        ...
        function huiyuanIdNumberChickValue(e){
            var this_val = e.value || 0;
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                huiyuanName: "会员姓名不能为空",
                huiyuanPhone: "会员手机号不能为空",
                huiyuanIdNumber: "会员身份证号不能为空",
                huiyuanPhoto: "会员照片不能为空",
                sexTypes: "性别不能为空",
            }
        }).form();
    }
