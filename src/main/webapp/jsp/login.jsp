        ...
        <form id="loginForm" action="" method="post" class="form">
            ...
            <div class="body-content">
				...
				<div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="员工" onclick="checkRole('yuangong')">&nbsp;员工
                        </label>
                    </div>
                </div>
                <div id="submitBtn" class="form-group"><button type="submit" class="btn btn-success" style="width: 100%;" onclick="login()">登 录</button></div>
				<%--<div class="form-group"><button type="button" class="btn btn-success" style="width: 100%;" onclick="window.location.href='./modules/yuangong/register.jsp'">注册  员工</button></div>--%>
